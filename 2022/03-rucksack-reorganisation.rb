...
# item types a through Z have priorities 1 through 52.
priority = [*'a'..'z', *'A'..'Z'].each.with_index(1).to_h

priorities = 0
rucksacks.each do |rucksack|
  compartment_1, compartment_2 = rucksack.chars.each_slice(rucksack.size/2).to_a

  priorities += priority[(compartment_1 & compartment_2).join]
end
...
labels = 0
rucksacks.each_slice(3).each do |group|
  elf_1, elf_2, elf_3 = group.map(&:chars)

  labels += priority[(elf_1 & elf_2 & elf_3).join]
end
