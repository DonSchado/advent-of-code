...
grid = DATA.read.chomp.split("\n")

alignments = []

grid.each_with_index do |line, y|
  if line.index('O')
    line.split('').each_with_index.reduce([]) { |memo, (c, i)| memo << i if c == 'O'; memo }.each do |x|
      alignments << x * y
    end
  end
end
